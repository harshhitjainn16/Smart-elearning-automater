...
Write-Host "║                                                            ║" -ForegroundColor Cyan
Write-Host "`n║     SMART E-LEARNING AUTOMATOR - FULL SUITE        ║" -ForegroundColor Green
Write-Host "║                                                            ║" -ForegroundColor Cyan
Write-Host "╚════════════════════════════════════════════════════════════╝" -ForegroundColor Cyan
Write-Host "`n"
...
Write-Host "`n✅ Chrome Extension Setup:" -ForegroundColor Green
...
try {
    ...
    Write-Host "   ℹ️  No existing processes found" -ForegroundColor Gray
}
...
Write-Host "`n⚠️  To STOP the dashboard: Press Ctrl+C in this window" -ForegroundColor Red
Write-Host "`n"
Write-Host "════════════════════════════════════════════════════════════" -ForegroundColor Cyan
Write-Host "`n"
